...
int32_t CanExGetDeviceCount(int flags);
int32_t CanExGetDeviceList(struct TCanDevicesList **devices_list, int flags);
...
int32_t CanExSetAsByte(uint32_t index, char *name, char value);
int32_t CanExSetAsWord(uint32_t index, char *name, int16_t value);
int32_t CanExSetAsLong(uint32_t index, char *name, int32_t value);
int32_t CanExSetAsUByte(uint32_t index, char *name, unsigned char value);
int32_t CanExSetAsUWord(uint32_t index, char *name, uint16_t value);
int32_t CanExSetAsULong(uint32_t index, char *name, uint32_t value);
int32_t CanExSetAsString(uint32_t index, char *name, char *value);
int32_t CanExGetAsByte(uint32_t index, char *name, char *value);
int32_t CanExGetAsWord(uint32_t index, char *name, int16_t *value);
int32_t CanExGetAsLong(uint32_t index, char *name, int32_t *value);
int32_t CanExGetAsUByte(uint32_t index, char *name, unsigned char *value);
int32_t CanExGetAsUWord(uint32_t index, char *name, uint16_t *value);
int32_t CanExGetAsULong(uint32_t index, char *name, uint32_t *value);
int32_t CanExGetAsString(uint32_t index, char *name, char **str);
